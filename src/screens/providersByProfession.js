...
const ProvidersByProfessionScreen = ({ navigation, route })=>{
    ...
    function Item({ item }) {
        return (
          <View style={styles.container}>
            ...
            <Text>{item.city} - {item.postalCode}</Text>
            <Text>{item.bio}</Text>
            </View>
            <View   style={{
            flexDirection: 'row',
            ...
            <TouchableOpacity style={{height:40,width:90, justifyContent:"center",alignItems:"center", backgroundColor: 'royalblue',borderRadius: 8,margin:4}}>
                <Text style={{color:"white"}}>View Profile</Text>
            </TouchableOpacity>
            <TouchableOpacity style={{height:40,width:90, justifyContent:"center",alignItems:"center", backgroundColor: 'mediumseagreen',borderRadius: 8,margin:4}}>
   ...
   return(
       <View >
           <Text>Showing {providersResult.length} Results for {profession}</Text>
